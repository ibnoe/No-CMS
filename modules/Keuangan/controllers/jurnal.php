...
class Jurnal extends CMS_Controller {
	...
	function index()
	{
		...
		$this->view('jurnal/display', $data,'Keuangan_jurnal');
	}
	...
	function jurnal_umum()
	{
		...
		// end
		$this->view('jurnal/form', $data, 'Keuangan_jurnal');
	}
	...
	function jurnal_koreksi()
		...
		$this->view('jurnal/koreksi', $data);
	}

	function buku_besar($id=0)
	{
		...
		$data['journal_data'] = $this->jurnal_model->get_data();
		$this->view('jurnal/buku_besar', $data,'Keuangan_buku_besar');
	}
