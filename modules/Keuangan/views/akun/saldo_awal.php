<script type="text/javascript" src="<?=base_url()?>assets/bbm/js/jurnal.js"></script>
...
<?php
	echo form_open('Keuangan/akun/input_saldo_awal', array('id' => 'saldo_awal_form', 'onsubmit' => 'return cekAkun();'));
	...
	if($account_data)
	{
		echo '<table id="tblDetail" name="tblDetail" class="sTable">';
		echo '<thead><tr>';
		echo '<th>Akun</th>';
		echo '<th>Debit</th>';
		echo '<th>Kredit</th>';
