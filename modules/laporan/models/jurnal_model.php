...
*/
	...
	function get_data()
	{
		$this->db->select('jurnal.id, jurnal.tgl, jurnal.no, jurnal.keterangan, jurnal.f_id AS f_id, f.nama AS f_name, jurnal.proyek_id,  jurnal_detail.item, jurnal_detail.akun_id, akun.nama as account_name, akun.kelompok_akun_id, jurnal_detail.debit_kredit, jurnal_detail.nilai');
		$this->db->from('jurnal');
